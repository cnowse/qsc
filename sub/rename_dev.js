...
const zh = ['新加坡', '狮城', '香港', '香港', '美国', '韩国', '南韩', '日本', '台湾', '英国', '德国', '卢森堡', '土耳其', '阿根廷', '迪拜', '阿联酋', '澳大利亚', '澳洲', '加拿大', '印度', '柬埔寨', '荷兰', '波兰', '泰国', '巴西', '法国', '俄国', '巴基斯坦', '意大利', '列支敦士登', '安道尔', '阿尔巴尼亚', '亚美尼亚', '奥地利', '阿塞拜疆', '波黑共和国', '孟加拉', '比利时', '马来西亚', '印度尼西亚', '印尼', '菲律宾', '尼日利亚', '越南', '摩尔多瓦', '乌克兰', '匈牙利', '西班牙', '智利', '新西兰', '以色列', '南非', '南极', '巴林', '白俄罗斯', '瑞士', '哥伦比亚', '哥斯达黎加', '荷属库拉索', '塞浦路斯', '捷克', '丹麦', '厄瓜多尔', '爱沙尼亚', '埃及', '芬兰', '委内瑞拉', '乌拉圭', '乌兹别克斯坦', '叙利亚'];
const en = ['SG', 'SG', 'HK', 'HK', 'US', 'KR', 'KR', 'JP', 'TW', 'GB', 'DE', 'LU', 'TR', 'AR', 'AE', 'AE', 'AU', 'AU', 'CA', 'IN', 'KH', 'NL', 'PL', 'TH', 'BR', 'FR', 'RU', 'PK', 'IT', 'LI', 'AD', 'AL', 'AM', 'AT', 'AZ', 'BA', 'BD', 'BE', 'MY', 'ID', 'ID', 'PH', 'NG', 'VN', 'MD', 'UA', 'HU', 'ES', 'CL', 'NZ', 'IL', 'ZA', 'AQ', 'BH', 'BY', 'CH', 'CO', 'CR', 'CW', 'CY', 'CZ', 'DK', 'EC', 'EE', 'EG', 'FI', 'VE', 'UY', 'UZ', 'SY'];
const enl = ['SGP', 'SGP', 'HKG', 'HKG', 'USA', 'KOR', 'KOR', 'JPN', 'TWN', 'GBR', 'DEU', 'LUX', 'TUR', 'ARG', 'ARE', 'ARE', 'AUS', 'AUS', 'CAN', 'IND', 'KHM', 'NLD', 'POL', 'THA', 'BRA', 'FRA', 'RUS', 'PAK', 'ITA', 'LIE', 'AND', 'ALB', 'ARM', 'AUT', 'AZE', 'BIH', 'BGD', 'BEL', 'MYS', 'IDN', 'IDN', 'PHL', 'NGA', 'VNM', 'MDA', 'UKR', 'HUN', 'ESP', 'CHL', 'NZL', 'ISR', 'ZAF', 'ATA', 'BHR', 'BLR', 'CHE', 'COL', 'CRI', 'CUW', 'CYP', 'CZE', 'DNK', 'ECU', 'EST', 'EGY', 'FIN', 'VEN', 'URY', 'UZB', 'SYR', ];
const enf = ['Singapore', 'Singapore', 'Hong Kong', 'HongKong', 'United States', 'Korea', 'Korea', 'Japan', 'Taiwan', 'England', 'Germany', 'Luxembourg', 'Turkey', 'Argentina', 'dubai', 'United Arab Emirates', 'Australia', 'Australia', 'Canada', 'India', 'Cambodia', 'Netherlands', 'Poland', 'Thailand', 'Brazil', 'France', 'Russia', 'Pakistan', 'Italy', 'Liechtenstein', 'andorra', 'Albania', 'armenia', 'Austria', 'Azerbaijan', 'Bosnia and Herzegovina', 'Bengal', 'Belgium', 'Malaysia', 'Indonesia', 'Indonesia', 'Philippines', 'nigeria', 'Vietnam', 'moldova', 'Ukraine', 'Hungary', 'Spain', 'Chile', 'new Zealand', 'Israel', 'South Africa', 'Antarctica', 'Bahrain', 'Belarus', 'Switzerland', 'Colombia', 'costa rica', 'Curacao', 'Cyprus', 'czech republic', 'Denmark', 'ecuador', 'Estonia', 'Egypt', 'Finland', 'Venezuela', 'Uruguay', 'Uzbekistan', 'Syria'];
