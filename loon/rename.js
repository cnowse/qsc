...
function operator(proxies) {
  ...
  if ($arguments.clear) {
    ...
    const order = {SG: 1, HK: 2, US: 3, JP: 4, TW: 5}
    proxies = proxies.sort((a, b) => order[a] - order[b]);
  };
  return proxies;
}