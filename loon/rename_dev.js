...
const en = ['SG', 'SG', 'HK', 'HK', 'US', 'KR', 'KR', 'JP', 'TW', 'GB', 'DE', 'LU', 'TR', 'AR', 'AE', 'AE', 'AU', 'AU', 'CA', 'IN', 'KH', 'NL', 'PL', 'TH', 'BR', 'FR', 'RU', 'PK', 'IT', 'LI', 'AD', 'AL', 'AM', 'AZ', 'BA', 'BD', 'BE', 'MY', 'ID', 'ID', 'PH', 'NG'];
const enl = ['SGP', 'SGP', 'HKG', 'HKG', 'USA', 'KOR', 'KOR', 'JPN', 'TWN', 'GBR', 'DEU', 'LUX', 'TUR', 'ARG', 'ARE', 'ARE', 'AUS', 'AUS', 'CAN', 'IND', 'KHM', 'NLD', 'POL', 'THA', 'BRA', 'FRA', 'RUS', 'PAK', 'ITA', 'LIE', 'AND', 'ALB', 'ARM', 'AZE', 'BIH', 'BGD', 'BEL', 'MYS', 'IDN', 'IDN', 'PHL', 'NGA'];
const enf = ['Singapore', 'Singapore', 'Hong Kong', 'HongKong', 'United States', 'Korea', 'Korea', 'Japan', 'Taiwan', 'England', 'Germany', 'Luxembourg', 'Turkey', 'Argentina', 'dubai', 'United Arab Emirates', 'Australia', 'Australia', 'Canada', 'India', 'Cambodia', 'Netherlands', 'Poland', 'Thailand', 'Brazil', 'France', 'Russia', 'Pakistan', 'Italy', 'Liechtenstein', 'andorra', 'Albania', 'armenia', 'Austria', 'Azerbaijan', 'Bosnia and Herzegovina', 'Bengal', 'Belgium', 'Malaysia', 'Indonesia', 'Philippines', 'nigeria'];
