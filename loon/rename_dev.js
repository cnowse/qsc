...
const zh = ['新加坡', '狮城', '香港', '香港', '美国', '韩国', '南韩', '日本', '台湾', '英国', '德国', '卢森堡', '土耳其', '阿根廷', '迪拜', '阿联酋', '澳大利亚', '澳洲', '加拿大', '印度', '柬埔寨', '荷兰', '波兰', '泰国', '巴西', '法国', '俄国', '巴基斯坦', '意大利', '列支敦士登', '安道尔', '阿尔巴尼亚', '亚美尼亚', '奥地利', '阿塞拜疆', '波黑共和国', '孟加拉', '比利时', '马来西亚', '印度尼西亚', '印尼', '菲律宾', '尼日利亚', '越南'];
const en = ['SG', 'SG', 'HK', 'HK', 'US', 'KR', 'KR', 'JP', 'TW', 'GB', 'DE', 'LU', 'TR', 'AR', 'AE', 'AE', 'AU', 'AU', 'CA', 'IN', 'KH', 'NL', 'PL', 'TH', 'BR', 'FR', 'RU', 'PK', 'IT', 'LI', 'AD', 'AL', 'AM', 'AT', 'AZ', 'BA', 'BD', 'BE', 'MY', 'ID', 'ID', 'PH', 'NG', 'VN'];
const enl = ['SGP', 'SGP', 'HKG', 'HKG', 'USA', 'KOR', 'KOR', 'JPN', 'TWN', 'GBR', 'DEU', 'LUX', 'TUR', 'ARG', 'ARE', 'ARE', 'AUS', 'AUS', 'CAN', 'IND', 'KHM', 'NLD', 'POL', 'THA', 'BRA', 'FRA', 'RUS', 'PAK', 'ITA', 'LIE', 'AND', 'ALB', 'ARM', 'AUT', 'AZE', 'BIH', 'BGD', 'BEL', 'MYS', 'IDN', 'IDN', 'PHL', 'NGA', 'VNM'];
const enf = ['Singapore', 'Singapore', 'Hong Kong', 'HongKong', 'United States', 'Korea', 'Korea', 'Japan', 'Taiwan', 'England', 'Germany', 'Luxembourg', 'Turkey', 'Argentina', 'dubai', 'United Arab Emirates', 'Australia', 'Australia', 'Canada', 'India', 'Cambodia', 'Netherlands', 'Poland', 'Thailand', 'Brazil', 'France', 'Russia', 'Pakistan', 'Italy', 'Liechtenstein', 'andorra', 'Albania', 'armenia', 'Austria', 'Azerbaijan', 'Bosnia and Herzegovina', 'Bengal', 'Belgium', 'Malaysia', 'Indonesia', 'Indonesia', 'Philippines', 'nigeria', 'Vietnam'];
